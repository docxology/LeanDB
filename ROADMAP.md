...
| R6 | Bases as packages, versioned typed migrations, hosting, importable bases (S0–S8) | S0–S7 done 2026-09-02 |
...
- **S0 — done 2026-09-02.** `LeanDb.Base` in the base library
  ...
  the same shape.
- **S1 — done 2026-09-02.** `Base.handle` (one transport-agnostic
  handler), `openDbRaw` + `Conn.verify`, `migrateOn`/`instanceInfoOn` on
...
- **S6 — done 2026-09-02.** `leandb host` (`LeanDb.Host`: spawns bases
